...
class SLLHT<K extends Comparable<K>, E> {
 ...
 public class Zad1_LABS5 {
    public static void main(String[] args) {
        ...
        vraboteni[1]=new Vraboten("zack","jackerson","Senior engener","1month bootcamp(he doesnt know sh*t (he just like me fr)",1);
        vraboteni[2]=new Vraboten("crack","jackerson","CTO","designed his verey own quantum computer at 4 yeras old",3);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if(rabotnik!=null){
                System.out.println("rabotniko: "+ rabotnik.info.value.ime);
